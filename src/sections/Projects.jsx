...
export default function Projects() {
  const projects = [
    ...
    {
      title: "AttendEase – Smart Subject-wise Attendance Tracker",
      image: attendease,
      description:
        "A subject-wise attendance tracker that solves what overall percentages hide — a student can be at 82% overall while failing the 75% cutoff in one subject. Tracks every subject independently, predicts exactly how many classes are needed to recover a shortage, and simulates whether it's safe to skip tomorrow's class.",
      tech: [
        "React",
        "Vite",
        "Tailwind CSS",
    ...
    {
      title: "ClaimGuard AI – Fake News Detection System",
      image: claimguard,
      description:
        "An AI-powered fact-checking system that extracts claims from news text, cross-references them against a knowledge base and live web search, and scores them for credibility instead of issuing a blunt true/false verdict. Built with a calibrated scoring engine and a Wikipedia-to-Tavily fallback for evidence retrieval.",
      tech: [
        "Python",
        "FastAPI",
        "React",
    ...
    {
      title: "DockFleet – Self-Healing Container Orchestrator",
      image: dockfleet,
      description:
        "A lightweight, self-healing alternative to Docker Compose for local multi-service stacks — deploys services from a single YAML file, monitors health continuously, and auto-restarts containers that fail repeatedly, with a real-time dashboard and crash analytics. Built as a 4-person team project; my contribution covered the dashboard and backend.",
      tech: [
        "Python",
        "FastAPI",
        "SQLite",
