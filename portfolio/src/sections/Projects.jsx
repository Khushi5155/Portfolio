...
export default function Projects() {
  ...
  return (
    <section
      id="projects"
      className="min-h-screen bg-[#0A192F] text-[#E6F1FF] px-6 py-24 flex flex-col items-center"
    >
      {/* Heading */}
      ...
      {/* Grid */}
      <div className="grid max-w-6xl w-full grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
        {projects.map((project, index) => (
          <Tilt
            ...
            className="relative group p-[2px] rounded-2xl 
                       ...
                       hover:from-[#00FF9D] hover:to-[#00c77d] transition-all duration-500"
          >
            {/* Card Content */}
            <div
            ...
            >
              ...
              <div className="absolute -top-10 -right-10 w-24 h-24 bg-[#00FF9D]/10 rounded-full blur-2xl opacity-0 group-hover:opacity-60 transition-all duration-700"></div>
              ...
              <div className="mt-6 flex gap-4">
                ...
                <a
                  ...
                  className="flex items-center gap-2 px-4 py-2 rounded-lg 
                             ...
                             transition-all duration-300 font-poppins text-sm
