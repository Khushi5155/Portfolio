      ...
      <div className="pt-20 md:pt-28 flex flex-col items-center text-center md:text-left md:flex-row gap-10">
        ...
        <div className="max-w-lg animate-slideUp">
          ...
          <div className="flex gap-5 mt-6 justify-center md:justify-start text-2xl">
            ...
            <a href="https://www.linkedin.com/in/khushi-kumari-bb4305327" className="hover:text-[#00FF9D] transition-all duration-300">
              <FaLinkedin />
            </a>
            <a href="mailto:kkaayana5155@gmail.com" className="hover:text-[#00FF9D] transition-all duration-300">
              <FaEnvelope />
            </a>
          </div>
        </div>
